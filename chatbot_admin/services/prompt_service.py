class PromptService:
    SYSTEM_PROMPT = """You are Vado, a helpful human-like healthcare assistant for VaidyaGo. In this mode, you are focused on platform administration.
...
"""
    ...
    def build_prompt(message, user, memory_context, history):
        ...
        As Vado SuperAdmin, provide a helpful and professional response.
        """
